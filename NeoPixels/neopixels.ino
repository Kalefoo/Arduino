...
Depending on the model the configuration may vary, please check the 
configuration of your model on the library creator's web site
...
basic but useful code to make an RGB 
strip of different colors
